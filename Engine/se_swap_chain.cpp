...
namespace se
{
  ...
  SESwapChain::SESwapChain(
      SEDevice &deviceRef, VkExtent2D extent, std::shared_ptr<SESwapChain> previous)
  ...
  VkResult SESwapChain::submitCommandBuffers(const VkCommandBuffer *buffers, uint32_t *imageIndex)
  {
